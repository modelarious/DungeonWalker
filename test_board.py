...
````````````
	...
	def test_connect_path_nodes_failure_state(self, point1, point2):
		...
		self.assertFalse(self.mapGeneratorEngine.connect_path_nodes(point1, point2))
	...
	def test_complex_case(self):
		...
		self.setUp_override((12, 12))
		self.mapGeneratorEngine.add_room(Room(3, 3, 1, 1))
		self.mapGeneratorEngine.add_room(Room(3, 3, 8, 4))
		self.mapGeneratorEngine.add_room(Room(3, 4, 3, 7))

		self.mapGeneratorEngine.connect_path_nodes((8, 5), (4, 7))
		self.mapGeneratorEngine.connect_path_nodes((3, 2), (4, 7))
...
# 		self.assertFalse(self.mapGeneratorEngine.connect_path_nodes((1, 3), (18, 3)))
...
# 		self.mapGeneratorEngine.connect_path_nodes(*((53, 26), (54, 37)))
...
# 		self.mapGeneratorEngine.connect_path_nodes(*((4, 21), (5, 34)))
